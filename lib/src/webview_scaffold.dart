...
class WebviewScaffold extends StatefulWidget {
  ...
  final List<String> acceptBaseUrl;
...
class _WebviewScaffoldState extends State<WebviewScaffold> {
  ...
  Widget build(BuildContext context) {
    final platformIsAndroid = Theme.of(context).platform == TargetPlatform.android;
    return Scaffold(
        ...
        onRectChanged: (Rect value) {
          if (_rect == null) {
            ...
            webviewReference.launch(
              ...
              acceptBaseUrl: platformIsAndroid ? widget.acceptBaseUrl : null
            );
          } else {
            if (_rect != value) {
              _rect = value;
